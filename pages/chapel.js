...
const Chapel = () => {
  ...
  return (
    <div className="w-screen h-screen flex">
      ...
      <Body />
      <button 
        className="quickbutton absolute bottom-8 right-8 h-24 w-24 bg-blue-600 flex justify-center items-center rounded-full focus:bg-blue-700 focus:outline-none transition"
        onClick={toggleSider}
      >
        {showSider ? 
